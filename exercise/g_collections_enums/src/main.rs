...
impl Shot {
    ...
    fn points(self) -> i32 {
        ...
        // - return 5 pointsclear if `self` is a `Shot::Bullseye`
...
fn main() {
    ...
    for coord in arrow_coords {
        ...
        // if coord.distance_from_center() < 1.0_f64 {
        //     shots.push(Shot::Bullseye);
        // } else if coord.distance_from_center() > 5.0_f64 {
        ...
        let shot = match coord.distance_from_center() {
            x if x < 1.0_f64 => Shot::Bullseye,
            x if x < 5.0_f64 => Shot::Hit(x),
            _ => Shot::Miss,
        };
        shots.push(shot);
    }
